/**
 * The web-search card's staged form over the `web-search-you` settings
 * namespace.
 *
...
/**
 * Namespace of the You.com search provider. Spelled here rather than
 * imported: a client package must not depend on a Host package.
 */
export const WEB_SEARCH_NS = 'web-search-you'

/** Credential reference the provider resolves when the section names none. */
const DEFAULT_API_KEY_REF = 'YDC_API_KEY'
...
export interface WebSearchSettings {
  ...
  baseURL?: string
  /** Default number of sources returned by You.com for one search. */
  numResults?: number
}
...
export interface WebSearchCardState extends CardShell {
  ...
  /** Sources requested from You.com for each search. */
...
/** Bridges the `web-search-you` scope and the credentials domain onto the card. */
export class WebSearchCardController {
  ...
  /**
   * @param scope - the bound settings scope for the `web-search-you` namespace.
