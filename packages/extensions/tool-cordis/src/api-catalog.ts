...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'computer',
    summary: 'Registry and deterministic target-aware router.',
    description: 'Registry and deterministic target-aware router. Providers remain stateless across calls.',
    methods: [
      {
        signature: 'register(provider: ComputerProvider): () => void',
        description: 'Register one target-aware Provider for the lifetime of the returned disposer.',
        parameters: [{ name: 'provider', description: 'Provider whose id must be unique in this runtime.' }],
        returns: 'a disposer that removes exactly this Provider registration.',
      },
      {
        signature: 'async listTargets(kind?: ComputerTargetKind, signal?: AbortSignal): Promise<readonly ComputerTarget[]>',
        description: 'List currently visible targets from every usable Provider.',
        parameters: [{ name: 'kind', description: 'Optional target category filter applied to Providers and results.' }, { name: 'signal', description: 'Optional cancellation signal forwarded to every selected Provider.' }],
        returns: 'the combined current target list.',
      },
      {
        signature: 'observe(target: ComputerTarget, mode: ComputerObservationMode = \'accessibility\', signal?: AbortSignal): Promise<ComputerObservation>',
        description: 'Observe a named target directly; discovery is not a prerequisite.',
        parameters: [{ name: 'target', description: 'Exact target to route by category.' }, { name: 'mode', description: 'Requested semantic, visual, or combined state.' }, { name: 'signal', description: 'Optional cancellation signal forwarded to the selected Provider.' }],
        returns: 'fresh bounded state for the target.',
      },
      {
        signature: 'perform(target: ComputerTarget, action: ComputerAction, signal?: AbortSignal): Promise<ComputerObservation>',
        description: 'Perform one bounded action through the target\'s Provider.',
        parameters: [{ name: 'target', description: 'Exact target to route by category.' }, { name: 'action', description: 'Input operation to perform.' }, { name: 'signal', description: 'Optional cancellation signal forwarded to the selected Provider.' }],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'ComputerObservationMode',
    declaration: 'export type ComputerObservationMode = \'accessibility\' | \'visual\' | \'both\';',
  },
  {
    name: 'ComputerPoint',
  ...
  {
    name: 'ComputerTarget',
    declaration: 'export type ComputerTarget = {\n    readonly kind: \'app\';\n    readonly id: string;\n    readonly name: string;\n} | {\n    readonly kind: \'browser-tab\';\n    readonly id: string;\n    readonly name: string;\n    readonly url?: string;\n} | {\n    readonly kind: \'desktop\';\n    readonly id: \'desktop\';\n    readonly name: \'Desktop\';\n};',
  },
  {
    name: 'ComputerTargetKind',
    declaration: 'export type ComputerTargetKind = \'app\' | \'browser-tab\' | \'desktop\';',
  },
  {
    name: 'ComputerVisualObservation',
    declaration: 'export interface ComputerVisualObservation {\n    readonly image: SaveImageAttachment;\n    readonly scope: \'desktop\' | \'window\' | \'browser-tab\';\n}',
  },
  {
    name: 'ConfinedArgv',
