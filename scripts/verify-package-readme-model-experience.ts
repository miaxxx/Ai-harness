...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/acp/acp-client': { kind: 'none', reason: 'Product-side subprocess transport; the spawned Runtime owns every model-visible effect.' },
  ...
  'packages/computer/computer': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-tool-computer.' },
  'packages/computer/computer-browser-cdp': { kind: 'indirect', reason: 'The browser backend delegates model rendering to dsh-tool-computer.' },
  'packages/computer/computer-macos': { kind: 'indirect', reason: 'The macOS backend delegates model rendering to dsh-tool-computer.' },
  ...
  'packages/web/web-search-you': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },
