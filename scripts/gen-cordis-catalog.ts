...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ComputerAction: 'computer.md',
  ComputerAccessibilityObservation: 'computer.md',
  ComputerBounds: 'computer.md',
  ComputerElement: 'computer.md',
  ComputerError: 'computer.md',
  ComputerErrorCode: 'computer.md',
  ComputerObservation: 'computer.md',
  ComputerObservationMode: 'computer.md',
  ComputerPoint: 'computer.md',
  ComputerProvider: 'computer.md',
  ComputerTarget: 'computer.md',
  ComputerTargetKind: 'computer.md',
  ComputerVisualObservation: 'computer.md',
